...
// Program Outline
// Input
// 	Two Integers, weight and distance.  ( 0< weight <= 20, 10 <= distance <
// 3000) Output 	the Charges, Weight,  and Distances Program Logic
// Input statement for user input 	make the validation statement for the
// input value 	make the decision structure to determine the rate based on weight
